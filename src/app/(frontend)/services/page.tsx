    ...
    <div className="py-24 bg-background min-h-screen">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-heading font-bold text-heading">Our Services</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service) => (
            <Link 
              ...
              key={service.id}
              className="bg-surface border border-border rounded-xl p-8 block hover:shadow-lg hover:-translate-y-1 transition-all group"
            >
