          ...
          {portfolio.map((item) => {
             ...
             return (
              <Link 
                ...
                key={item.id}
                className="group relative rounded-xl overflow-hidden bg-surface border border-border block hover:shadow-xl transition-all"
              >
                <div className="aspect-[4/3] w-full relative">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-heading/80 to-transparent opacity-80 group-hover:opacity-100 transition-opacity" />
                </div>
